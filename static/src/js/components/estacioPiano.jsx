...
import { GrufKnobGran, GrufKnobPetit, GrufLabel, GrufEnum2Columns, GrufReverbTime, GrufSlider } from "./widgets";
...
export const EstacioPianoUI = ({estacio}) => {
    ...
    return (<div key={estacio.nom} className="estacio estacio-piano">
        <div className="estacio-main">
            ...
            <GrufSlider estacio={estacio} parameterName="Timbre" top="30%" left="70%" />
        </div>
