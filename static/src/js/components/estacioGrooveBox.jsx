...
export const EstacioGrooveBoxUI = ({estacio, setEstacioSelected}) => {
    ...
    return (<div key={estacio.nom} className="estacio estacio-grooveBox">
        <div className="estacio-main">
            <GrufKnobGran estacio={estacio} parameterName="volume1" top="7%" left="6.3%" label="Vol" />
            <GrufKnobGran estacio={estacio} parameterName="swing1" top="7%" left="17.8%" label = 'Swing' />
            <GrufKnobGran estacio={estacio} parameterName="swing2" top="7%" left="29.0%" label = 'Tempo' />
            ...
            <GrufKnobPetit estacio={estacio} parameterName="reverbSend1" top="6.6%" left="72.8%" label = 'Send' />
            ...
            <GrufLabel text="EQ" top="29.5%" left="51.7%" />
            <GrufKnobPetit estacio={estacio} parameterName="reverbSend1" top="34.5%" left="51.9%" label = 'Low' />
            ...
            <GrufKnobPetit estacio={estacio} parameterName="atack3" top="72.5%" left="77%" label = 'Attack' />
            <GrufKnobPetit estacio={estacio} parameterName="release3" top="72.5%" left="82%" label = 'Release' />
            ...
            <GrufKnobPetit estacio={estacio} parameterName="atack4" top="85%" left="77%" label = 'Attack' />
            <GrufKnobPetit estacio={estacio} parameterName="release4" top="85%" left="82%" label = 'Release' />
