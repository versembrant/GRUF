    ...
    return (
        <div key={estacio.nom} className="estacio estacio-sampler">
            <div className="estacio-main grid gap-10 p-4">
                ...
                <GrufModulADSR className="col-start-2 row-start-1 row-span-3" estacio={estacio} soundNumber={selectedPad + 1} availableParameters={["attack", "release"]} includeVolume={true}/>
